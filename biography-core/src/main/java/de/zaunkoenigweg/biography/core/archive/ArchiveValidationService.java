...
public class ArchiveValidationService {
    ...
    public Pair<Boolean, List<Pair<String, Boolean>>> check(File file) {
        ...
        if(!doesMetadataDatetimeOriginalMatchFilename(file)) {
    		checks.add(Pair.of("DatetimeOriginal in filename does not match the corresponding value in metadata.", Boolean.FALSE));
    		return Pair.of(Boolean.FALSE, checks);
		}
		checks.add(Pair.of("DatetimeOriginal in filename does match the corresponding value in metadata.", Boolean.TRUE));
     ...
     * @throws {@link NullPointerException} if the file object is <code>null</code>
     * @throws {@link IllegalArgumentException} if the file does not exist (or is a directory)
     * @throws {@link IllegalArgumentException} if the file does not pass {@link #hasMediaFileName(File)}!
     */
     ...
     * @throws {@link NullPointerException} if the file object is <code>null</code>
     * @throws {@link IllegalArgumentException} if the file does not exist (or is a directory)
     * @throws {@link IllegalArgumentException} if the file does not pass {@link #isInCorrectArchiveFolder(File)}!
     */
    public boolean hasMetadata(File file) {
    	if(!isInCorrectArchiveFolder(file)) {
    		throw new IllegalArgumentException(String.format("File '%s' is no valid media file in archive.", file.getAbsolutePath()));
    	}
     ...
     * @throws {@link NullPointerException} if the file object is <code>null</code>
     * @throws {@link IllegalArgumentException} if the file does not exist (or is a directory)
     * @throws {@link IllegalArgumentException} if the file does not pass {@link #hasMetadata(File)}!
     */
     ...
     * @throws {@link NullPointerException} if the file object is <code>null</code>
     * @throws {@link IllegalArgumentException} if the file does not exist (or is a directory)
     * @throws {@link IllegalArgumentException} if the file does not pass {@link #doesMetadataDatetimeOriginalMatchFilename(File)}!
     */
