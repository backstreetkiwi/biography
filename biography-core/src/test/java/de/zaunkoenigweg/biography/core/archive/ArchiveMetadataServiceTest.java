...
public class ArchiveMetadataServiceTest {
	...
	/*
	 * During the imports of newer files (October 2018) I recognized an encoding fuckup which I could not
	 * clarify. It had somehow to do with the encoding and using special chars.
	 * These tests provide examples...
	 */
